...
def test_request_client_credentials_token_is_successful():
    disco_doc_response = get_discovery_document(DiscoveryDocumentRequest(address=TEST_DISCO_ADDRESS))

    client_creds_req = ClientCredentialsTokenRequest(client_id=TEST_CLIENT_ID,
...
def test_request_client_credentials_token_fails():
    ...
    client_creds_req = ClientCredentialsTokenRequest(client_id='bad_client_id',
